...
class PresentationState {
  final List<SangeetTrackObject> selectedTracks;
  final List<SangeetTrackObject> presentationTracks;
  final SortBy sortBy;
  ...
  PresentationState copyWith({
    List<SangeetTrackObject>? selectedTracks,
    List<SangeetTrackObject>? presentationTracks,
    SortBy? sortBy,
  }) {
...
class PresentationStateNotifier
  ...
  bool get isSavedTrackPlaylist =>
      arg is SangeetSimplePlaylistObject &&
      (arg as SangeetSimplePlaylistObject).id == "user-liked-tracks";

  List<SangeetTrackObject> get tracks {
    assert(
      arg is SangeetSimplePlaylistObject || arg is SangeetSimpleAlbumObject,
      "arg must be SangeetSimplePlaylistObject or SangeetSimpleAlbumObject",
    );

    final isPlaylist = arg is SangeetSimplePlaylistObject;
  ...
  void selectTrack(SangeetTrackObject track) {
  ...
  void deselectTrack(SangeetTrackObject track) {
    state = state.copyWith(
