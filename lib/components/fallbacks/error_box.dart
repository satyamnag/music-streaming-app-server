      ...
      child: Padding(
        ...
        child: Card(
          child: Column(
            ...
            children: [
              Basic(
                leading: const Icon(SangeetIcons.error),
                contentSpacing: 8,
              ...
              Row(
                ...
                children: [
                  Button.text(
                    leading: const Icon(SangeetIcons.logs),
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (context) {
                                ...
                                HookBuilder(builder: (context) {
                                  ...
                                  return Button.ghost(
                                    leading: copied.value
                                        ? const Icon(SangeetIcons.done)
                                        : const Icon(SangeetIcons.clipboard),
                  ...
                  if (onRetry != null)
                    Button.text(
                      leading: const Icon(SangeetIcons.refresh),
                      onPressed: onRetry,
