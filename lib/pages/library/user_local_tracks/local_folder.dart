...
import 'package:sangeet/modules/library/local_folder/cache_export_dialog.dart';
import 'package:sangeet/pages/library/user_local_tracks/user_local_tracks.dart';
import 'package:sangeet/components/expandable_search/expandable_search.dart';
...
class LocalLibraryPage extends HookConsumerWidget {
  ...
  Future<void> playLocalTracks(
    WidgetRef ref,
    List<SangeetLocalTrackObject> tracks, {
    SangeetLocalTrackObject? currentTrack,
  }) async {
              ...
              if (isCache) ...[
                IconButton.outline(
                  ...
                  icon: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(SangeetIcons.delete),
                ...
                IconButton.outline(
                  ...
                  icon: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(SangeetIcons.export),
                      Text(
                        context.l10n.export,
                      )
                    ],
                  ...
                  children: [
                    ...
                    Tooltip(
                      ...
                      child: IconButton.outline(
                        ...
                        icon: const Icon(SangeetIcons.shuffle),
                      ),
                    ),
                    const Gap(5),
                    Tooltip(
                    ...
                    const Gap(5),
                    IconButton.outline(
                      icon: const Icon(SangeetIcons.refresh),
                      onPressed: () {
                        ref.invalidate(localTracksProvider);
                      },
                    )
                  ...
                  data: (tracks) {
                    final sortedTracks = useMemoized(() {
                      return ServiceUtils.sortTracks(
                          tracks[location] ?? <SangeetLocalTrackObject>[],
                          sortBy.value);
                    }, [sortBy.value, tracks]);
