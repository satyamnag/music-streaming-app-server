...
import 'package:sangeet/modules/metadata_plugins/installed_plugin.dart';
import 'package:sangeet/modules/metadata_plugins/plugin_repository.dart';
import 'package:sangeet/provider/metadata_plugin/core/repositories.dart';
          ...
          return availablePlugins.where(
            (d) {
              return d.topics.contains(
                tabState.value == 1
                    ? "sangeet-metadata-plugin"
                    : "sangeet-audio-source-plugin",
              );
            },
          ).toList();
        }
                  ...
                  children: [
                    ...
                    Tooltip(
                      ...
                      child: IconButton.primary(
                        icon: const Icon(SangeetIcons.upload),
                        onPressed: () async {
                          Uint8List bytes;
                          ...
                          if (kIsFlatpak) {
                            final result = await openFile(
                              acceptedTypeGroups: [
                                const XTypeGroup(
                                  label: 'Soulful Bhakti Metadata Plugin',
                                  extensions: ['smplug'],
                                ),
                              ],
                            );
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              spacing: 8,
                              children: [
                                const Icon(SangeetIcons.warning, size: 16),
                                Text(
