...
class PlaybackHistoryActions {
  ...
  Future<void> addPlaylists(List<SangeetSimplePlaylistObject> playlists) async {
  ...
  Future<void> addAlbums(List<SangeetSimpleAlbumObject> albums) async {
    await _batchInsertHistoryEntries([
  ...
  Future<void> addTracks(List<SangeetTrackObject> tracks) async {
    assert(
