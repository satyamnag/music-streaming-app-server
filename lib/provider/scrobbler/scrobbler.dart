...
class ScrobblerNotifier extends AsyncNotifier<Scrobblenaut?> {
  final StreamController<SangeetTrackObject> _scrobbleController =
      StreamController<SangeetTrackObject>.broadcast();
  @override
  build() async {
  ...
  Future<void> love(SangeetTrackObject track) async {
  ...
  Future<void> unlove(SangeetTrackObject track) async {
