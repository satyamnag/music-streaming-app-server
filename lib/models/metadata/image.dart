...
@freezed
class SangeetImageObject with _$SangeetImageObject {
  factory SangeetImageObject({
    required String url,
    int? width,
    int? height,
  }) = _SangeetImageObject;

  factory SangeetImageObject.fromJson(Map<String, dynamic> json) =>
      _$SangeetImageObjectFromJson(json);
}
...
extension SangeetImageExtensions on List<SangeetImageObject>? {
