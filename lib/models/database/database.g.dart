...
class $LocalLikedSongsTableTable extends LocalLikedSongsTable
    with TableInfo<$LocalLikedSongsTableTable, LocalLikedSongsTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $LocalLikedSongsTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  @override
  VerificationContext validateIntegrity(
      Insertable<LocalLikedSongsTableData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  @override
  $LocalLikedSongsTableTable createAlias(String alias) {
    return $LocalLikedSongsTableTable(attachedDatabase, alias);
  }
}
...
typedef $$LocalPlaylistSongsTableTableProcessedTableManager
    = ProcessedTableManager<
        ...
        LocalPlaylistSongsTableData,
        PrefetchHooks Function({bool playlistId})>;
typedef $$LocalLikedSongsTableTableCreateCompanionBuilder
    = LocalLikedSongsTableCompanion Function({
  Value<int> id,
  required String trackId,
  Value<DateTime> createdAt,
});
typedef $$LocalLikedSongsTableTableUpdateCompanionBuilder
    = LocalLikedSongsTableCompanion Function({
  Value<int> id,
  Value<String> trackId,
  Value<DateTime> createdAt,
...
class $$LocalLikedSongsTableTableFilterComposer
    extends Composer<_$AppDatabase, $LocalLikedSongsTableTable> {
  $$LocalLikedSongsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalLikedSongsTableTableOrderingComposer
    extends Composer<_$AppDatabase, $LocalLikedSongsTableTable> {
  $$LocalLikedSongsTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalLikedSongsTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $LocalLikedSongsTableTable> {
  $$LocalLikedSongsTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalLikedSongsTableTableTableManager extends RootTableManager<
    _$AppDatabase,
    $LocalLikedSongsTableTable,
    LocalLikedSongsTableData,
    $$LocalLikedSongsTableTableFilterComposer,
    $$LocalLikedSongsTableTableOrderingComposer,
    $$LocalLikedSongsTableTableAnnotationComposer,
    $$LocalLikedSongsTableTableCreateCompanionBuilder,
    $$LocalLikedSongsTableTableUpdateCompanionBuilder,
    (
      LocalLikedSongsTableData,
      BaseReferences<_$AppDatabase, $LocalLikedSongsTableTable,
          LocalLikedSongsTableData>
    ),
    LocalLikedSongsTableData,
    PrefetchHooks Function()> {
  $$LocalLikedSongsTableTableTableManager(
      _$AppDatabase db, $LocalLikedSongsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$LocalLikedSongsTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$LocalLikedSongsTableTableOrderingComposer(
                  $db: db, $table: table),
          createComputedFieldComposer: () =>
...
typedef $$LocalLikedSongsTableTableProcessedTableManager
    = ProcessedTableManager<
        _$AppDatabase,
        $LocalLikedSongsTableTable,
        LocalLikedSongsTableData,
