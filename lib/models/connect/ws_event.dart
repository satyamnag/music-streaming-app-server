...
class WebSocketAddTrackEvent extends WebSocketEvent<SangeetFullTrackObject> {
  WebSocketAddTrackEvent(SangeetFullTrackObject data)
      : super(WsEvent.addTrack, data);

  WebSocketAddTrackEvent.fromJson(Map<String, dynamic> json)
      : super(
          WsEvent.addTrack,
          SangeetFullTrackObject.fromJson(
