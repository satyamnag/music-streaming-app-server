...
final validTopics = {
  "sangeet-metadata-plugin": ("Metadata", SangeetIcons.album),
  "sangeet-audio-source-plugin": ("Audio Source", SangeetIcons.music),
};
            ...
            children: [
              ...
              SecondaryBadge(
                leading: host == "github.com"
                    ? const Icon(SangeetIcons.github)
                    : null,
                child: Text(host),
                onPressed: () {
                  launchUrlString(pluginRepo.repoUrl);
