...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get u_love_spotube => 'Sabemos que te encanta Sangeet';

  @override
  String get check_for_updates => 'Buscar actualizaciones';

  @override
  String get about_spotube => 'Acerca de Sangeet';
  ...
  String get spotube_description =>
      'Sangeet, un cliente ligero, multiplataforma y gratuito de Spotify';
  ...
  String get download_ip_ban_warning =>
      'Por cierto, tu IP puede ser bloqueada en YouTube debido a solicitudes de descarga excesivas. El bloqueo de IP significa que no podrás usar YouTube (incluso si has iniciado sesión) durante al menos 2-3 meses desde esa dirección IP. Y Sangeet no se hace responsable si esto ocurre alguna vez';
  ...
  String get download_agreement_3 =>
      'Soy completamente consciente de que mi IP puede ser bloqueada en YouTube y no responsabilizo a Sangeet ni a sus dueños/contribuyentes por cualquier incidente causado por mi acción actual';
  ...
  String get encryption_failed_warning =>
      'Sangeet utiliza el cifrado para almacenar sus datos de forma segura. Pero ha fallado. Por lo tanto, volverá a un almacenamiento no seguro\nSi está utilizando Linux, asegúrese de tener instalados servicios secretos como gnome-keyring, kde-wallet y keepassxc';
  ...
  String get choose_your_region_description =>
      'Esto ayudará a Sangeet a mostrarte el contenido adecuado\npara tu ubicación.';
  ...
  String get help_project_grow_description =>
      'Sangeet es un proyecto de código abierto. Puedes ayudar a que este proyecto crezca contribuyendo al proyecto, informando errores o sugiriendo nuevas funciones.';
  ...
  String get enable_connect_description =>
      'Controla Sangeet desde otros dispositivos';
  ...
  @override
  String get spotube_has_an_update => 'Sangeet tiene una actualización';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Sangeet Nightly $nightlyBuildNum ha sido lanzado';
  }

  @override
  String release_version(Object version) {
    return 'Sangeet v$version ha sido lanzado';
  }
